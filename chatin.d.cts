...
declare class ChatFunctionsController {
     ...
     */
    constructor(openai: OpenAIApi, options?: Partial<ChatFunctionsControllerOptions>);
    /** Register a new plugin with function decorators.
     * @param plugin The plugin to register.
     * @param options Options for registering the plugin.
     */
    registerFunctions(plugin: any, options?: Partial<RegisterFunctionsOptions>): void;
     ...
     */
    getFunctionMessageFromMessage(message: ChatCompletionRequestMessage, options?: Partial<GetFunctionMessageOptions>): Promise<ChatCompletionRequestMessage>;
     ...
     * @returns The function message.
     */
    getFunctionMessage(name: string, args: string, options?: Partial<GetFunctionMessageOptions>): Promise<ChatCompletionRequestMessage>;
     ...
     */
    getCompletionWithMessage(message: ChatCompletionRequestMessage, options?: Partial<GetCompletionOptions>): Promise<axios.AxiosResponse<openai.CreateChatCompletionResponse, any>>;
    /** Get the next completion without adding a message to the conversation.
     * @param options Options for getting the completion.
     */
    getNextCompletion(options?: Partial<GetCompletionOptions>): Promise<axios.AxiosResponse<openai.CreateChatCompletionResponse, any>>;
